...
P.s. Если что-то установится не правильно - установите библиотеки самостоятельно!
```sh
Автоматическая установка виртуального окружения и всех библиотек описаны в Readme.md файлах в папках!
```
